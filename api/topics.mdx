...
A topic becomes Knowledge only once a human merges it in. See [Governance](/concepts/governance). `approve` / `reject` and Suggested-edit `merge` / `reject` require a human identity.
