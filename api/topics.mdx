...
| Method | Path | Purpose |
|---|---|---|
| `GET` | `/workspaces/:slug/topics/search` | Full-text search, relevance-ranked. `?tags=a,b` scopes to topics carrying ANY of those tags; `?limit=` caps the result set (default 50); archived topics are never returned |
