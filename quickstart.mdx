---
title: 'Quickstart'
description: "Add Driftless to your coding agent and watch your first team memory appear — in about a minute."
---

Driftless is shared memory for your codebase. Your coding agent reads what the team already knows before it edits, and writes back what it learns. You don't learn a system — your agent does. Here's the whole setup.
...
- [The Driftless loop](/concepts/core-loop) — how memory compounds across a team.
- [Topics & kinds](/concepts/topics) — decisions, runbooks, integration notes, and the fields each one carries.
