...
description: 'Server-side agents that keep your team context honest and grow it — they write notes, a human adds them to knowledge.'
---

Driftless can run two specialized agents on your codebase. They don't replace a reviewer — they review and grow your team's **recorded context**: the `gotchas`, `decisions`, and `invariants` your team wrote down. Both **write notes**; a human **adds them to knowledge**.
...
- **Propose-only, human-gated.** Everything they produce lands as a **Note** or **Suggested edit** in your Review Queue. Only a human merges it into Knowledge. An agent can never merge its own work in.
