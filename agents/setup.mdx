...
2. **Load topic context** — `driftless context get <slug>` or `driftless context get --files "src/auth/**"`
...
This installs AGENTS.md and CLAUDE.md into the current repo. Use this when you want agent context loading without any additional setup.
