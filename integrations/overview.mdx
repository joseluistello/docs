...
- **Integration** is the stored link in general. Today two kinds exist: Broker **Connections** (`nango:<provider>`) and the **GitHub App** (`github`), which is a different surface with a different purpose (see [Provider availability](#provider-availability)).
...
- [GitHub App](/integrations/github-app) - the observation surface (drift and Auditor).
