...
<CardGroup cols={2}>
  ...
  <Card title="Remote MCP" icon="plug">
    The agent calls Driftless tools (`driftless_context_*`, `driftless_collection`, `tags`, …) over the hosted MCP endpoint, no shell or repo checkout required. Best for agents operating from an AI client.
  </Card>
</CardGroup>
