...
description: 'Every command, flag, and example.'
---
...
| `install-skill` | _(none)_ | Install AGENTS.md + CLAUDE.md | `driftless install-skill` |
...
| `context search` | _(query)_, `--json` | Full-text search | `driftless context search "payment"` |
