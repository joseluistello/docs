...
A topic is authoritative only if approved. Lifecycle: `draft → proposed → reviewed → archived`. Agents propose; humans approve. See [Governance](/concepts/governance).

| Command | Description | Example |
|---|---|---|
| `context propose <topic>` | Submit a draft for review | `driftless context propose payment-flow` |
| `context approve <topic>` | Make it authoritative (human) | `driftless context approve payment-flow` |
