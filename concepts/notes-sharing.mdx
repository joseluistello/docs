...
When a note is durable enough for the whole team, it climbs the trust axis: **Note → Up for review → Knowledge**. Merging is an owner/admin act — an owner/admin merges it, or explicitly asks an agent to run the merge on their behalf. This is the team's source of truth that agents pull before they edit. See [Governance](/concepts/governance) for the full lifecycle and the merge commands.
