...
- **[Topics](/concepts/topics)**: what the team knows, with the Note → Knowledge lifecycle.
...
|---|---|---|
| **Dashboard** | Clerk session (the human) | The URL: `app.trybrein.com/w/:slug`. Legacy `app.driftless.icu` links redirect to the same app. |
