...
description: 'A deterministic Claude Code hook that injects authoritative context before every edit — the gate, paying off.'
---

The skill *asks* the agent to pull context before editing (UC1). **Auto-pull** makes it deterministic: a Claude Code **PreToolUse hook** injects the team's **authoritative System context** for a file *before every edit* — no one has to remember.
...
4. On → it matches topics for the file and injects ONLY authoritative
