...
these are Suggested edits; a human merges them.
...
- **It informs; it never blocks.** Findings land as Suggested edits in the Review Queue — a human merges them. No coverage score, no homework.
