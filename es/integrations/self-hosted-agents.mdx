...
<CardGroup cols={2}>
  ...
  <Card title="MCP remoto" icon="plug">
    El agente llama a las tools de Driftless (`driftless_context_*`, `driftless_collection`, `tags`, …) sobre el endpoint MCP hosteado, sin necesidad de shell ni de un checkout del repo. Es ideal para agentes que operan desde un cliente de IA.
  </Card>
</CardGroup>
...
| API key | Dashboard → **Settings → API Keys** en [app.driftless.icu](https://app.trybrein.com) |
