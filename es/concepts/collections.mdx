...
- **`distill_policy`**: cómo un record terminal se destila de vuelta en una Nota (la costura que sube): cerrar un bug o ganar un deal puede dejar un aprendizaje durable en el vault.
