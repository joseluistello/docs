...
| Market data | `driftless_market_data`: suppliers, opportunities, awards, marcas de riesgo y permits — once actions semánticas, sin modelo ni SQL detrás | [Market Data](/es/api/market-data) |
