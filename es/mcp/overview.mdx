...
| Market data | Catorce tools tipadas `driftless_market_*`: suppliers, detalle por lote acotado y comparación de segmentos, opportunities, awards, marcas de riesgo y permits, sin modelo ni SQL detrás. `driftless_market_data` es un shim de compatibilidad deprecado. Reconecta los clientes después de cambios de schema porque los conectores pueden guardar definiciones de tools en caché. | [Market Data](/es/api/market-data) |
