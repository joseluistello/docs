...
description: "Pull evidence from a connected tool into a Project or Collection through the Broker, without confusing it with Knowledge or with normal retrieve. Read-only today; the write path is described but gated."
---
